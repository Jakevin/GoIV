...
import com.jakevin.pokeshout.clipboard.ClipboardTokenHandler;
import com.jakevin.pokeshout.logic.CPRange;
import com.jakevin.pokeshout.logic.Data;
...
import com.jakevin.pokeshout.logic.PokeSpam;
import com.jakevin.pokeshout.logic.Pokemon;
import com.jakevin.pokeshout.logic.PokemonNameCorrector;
import com.jakevin.pokeshout.logic.ScanContainer;
import com.jakevin.pokeshout.logic.ScanResult;
import com.jakevin.pokeshout.logic.UpgradeCost;
import com.jakevin.pokeshout.widgets.IVResultsAdapter;
import com.jakevin.pokeshout.widgets.PokemonSpinnerAdapter;
...
import static com.jakevin.pokeshout.GoIVSettings.APPRAISAL_WINDOW_POSITION;
...
public class Pokefly extends Service {
    ...
    @BindView(com.jakevin.pokeshout.R.id.autoCompleteTextView1)
    AutoCompleteTextView autoCompleteTextView1;

    @BindView(com.jakevin.pokeshout.R.id.pokePickerToggleSpinnerVsInput)
    Button pokePickerToggleSpinnerVsInput;


    private PokemonSpinnerAdapter pokeInputSpinnerAdapter;
    @BindView(com.jakevin.pokeshout.R.id.spnPokemonName)
    Spinner pokeInputSpinner;

    @BindView(com.jakevin.pokeshout.R.id.tvSeeAllPossibilities)
    TextView seeAllPossibilities;
    @BindView(com.jakevin.pokeshout.R.id.etCp)
    EditText pokemonCPEdit;
    @BindView(com.jakevin.pokeshout.R.id.etHp)
    EditText pokemonHPEdit;
    @BindView(com.jakevin.pokeshout.R.id.etCandy)
    EditText pokemonCandyEdit;
    @BindView(com.jakevin.pokeshout.R.id.sbArcAdjust)
    SeekBar arcAdjustBar;
    @BindView(com.jakevin.pokeshout.R.id.llButtonsInitial)
    LinearLayout initialButtonsLayout;
    @BindView(com.jakevin.pokeshout.R.id.llButtonsOnCheck)
    LinearLayout onCheckButtonsLayout;


    @BindView(com.jakevin.pokeshout.R.id.appraisalIvRange)
    Spinner appraisalIvRange;
    @BindView(com.jakevin.pokeshout.R.id.appraisalPercentageRange)
    Spinner appraisalPercentageRange;

    // Layouts
    @BindView(com.jakevin.pokeshout.R.id.inputBox)
    LinearLayout inputBox;
    @BindView(com.jakevin.pokeshout.R.id.resultsBox)
    LinearLayout resultsBox;
    @BindView(com.jakevin.pokeshout.R.id.expandedResultsBox)
    LinearLayout expandedResultsBox;
    @BindView(com.jakevin.pokeshout.R.id.allPossibilitiesBox)
    LinearLayout allPossibilitiesBox;

    @BindView(com.jakevin.pokeshout.R.id.appraisalBox)
    LinearLayout appraisalBox;

    // Result data
    private PokemonSpinnerAdapter extendedEvolutionSpinnerAdapter;

    @BindView(com.jakevin.pokeshout.R.id.extendedEvolutionSpinner)
    Spinner extendedEvolutionSpinner;

    @BindView(com.jakevin.pokeshout.R.id.resultsMinPercentage)
    TextView resultsMinPercentage;
    @BindView(com.jakevin.pokeshout.R.id.resultsAvePercentage)
    TextView resultsAvePercentage;
    @BindView(com.jakevin.pokeshout.R.id.resultsMaxPercentage)
    TextView resultsMaxPercentage;
    @BindView(com.jakevin.pokeshout.R.id.resultsPokemonLevel)
    TextView resultsPokemonLevel;
    @BindView(com.jakevin.pokeshout.R.id.exResCandy)
    TextView exResCandy;
    @BindView(com.jakevin.pokeshout.R.id.exResLevel)
    TextView exResLevel;
    @BindView(com.jakevin.pokeshout.R.id.resultsPokemonName)
    TextView resultsPokemonName;
    @BindView(com.jakevin.pokeshout.R.id.resultsCombinations)
    TextView resultsCombinations;
    @BindView(com.jakevin.pokeshout.R.id.exResultCP)
    TextView exResultCP;
    @BindView(com.jakevin.pokeshout.R.id.exResultHP)
    TextView exResultHP;
    @BindView(com.jakevin.pokeshout.R.id.exResultPercentPerfection)
    TextView exResultPercentPerfection;
    @BindView(com.jakevin.pokeshout.R.id.explainCPPercentageComparedToMaxIV)
    TextView explainCPPercentageComparedToMaxIV;
    @BindView(com.jakevin.pokeshout.R.id.exResStardust)
    TextView exResStardust;
    @BindView(com.jakevin.pokeshout.R.id.exResPrevScan)
    TextView exResPrevScan;
    @BindView(com.jakevin.pokeshout.R.id.exResCompare)
    TextView exResCompare;
    @BindView(com.jakevin.pokeshout.R.id.resultsMoreInformationText)
    TextView resultsMoreInformationText;
    @BindView(com.jakevin.pokeshout.R.id.expandedLevelSeekbar)
    SeekBar expandedLevelSeekbar;
    @BindView(com.jakevin.pokeshout.R.id.expandedLevelSeekbarBackground)
    MultiSlider expandedLevelSeekbarBackground;
    @BindView(com.jakevin.pokeshout.R.id.llSingleMatch)
    LinearLayout llSingleMatch;
    @BindView(com.jakevin.pokeshout.R.id.tvAvgIV)
    TextView tvAvgIV;
    @BindView(com.jakevin.pokeshout.R.id.resultsAttack)
    TextView resultsAttack;
    @BindView(com.jakevin.pokeshout.R.id.resultsDefense)
    TextView resultsDefense;
    @BindView(com.jakevin.pokeshout.R.id.resultsHP)
    TextView resultsHP;
    @BindView(com.jakevin.pokeshout.R.id.llMaxIV)
    LinearLayout llMaxIV;
    @BindView(com.jakevin.pokeshout.R.id.llMinIV)
    LinearLayout llMinIV;
    @BindView(com.jakevin.pokeshout.R.id.llMultipleIVMatches)
    LinearLayout llMultipleIVMatches;
    @BindView(com.jakevin.pokeshout.R.id.refine_by_last_scan)
    LinearLayout refine_by_last_scan;

    @BindView(com.jakevin.pokeshout.R.id.inputAppraisalExpandBox)
    TextView inputAppraisalExpandBox;

    @BindView(com.jakevin.pokeshout.R.id.rvResults)
    RecyclerView rvResults;

    //PokeSpam
    @BindView(com.jakevin.pokeshout.R.id.llPokeSpamDialogInputContentBox)
    LinearLayout pokeSpamDialogInputContentBox;
    @BindView(com.jakevin.pokeshout.R.id.llPokeSpam)
    LinearLayout pokeSpamView;
    @BindView(com.jakevin.pokeshout.R.id.exResPokeSpam)
    TextView exResPokeSpam;

    // Refine by appraisal
    @BindView(com.jakevin.pokeshout.R.id.attCheckbox)
    CheckBox attCheckbox;
    @BindView(com.jakevin.pokeshout.R.id.defCheckbox)
    CheckBox defCheckbox;
    @BindView(com.jakevin.pokeshout.R.id.staCheckbox)
    CheckBox staCheckbox;

    @BindView(com.jakevin.pokeshout.R.id.positionHandler)
    ...
    public void onCreate() {
        ...
        pokeInfoCalculator = PokeInfoCalculator.getInstance(
                getResources().getStringArray(com.jakevin.pokeshout.R.array.pokemon),
                getResources().getIntArray(com.jakevin.pokeshout.R.array.attack),
                getResources().getIntArray(com.jakevin.pokeshout.R.array.defense),
                getResources().getIntArray(com.jakevin.pokeshout.R.array.stamina),
                getResources().getIntArray(com.jakevin.pokeshout.R.array.devolutionNumber),
                getResources().getIntArray(com.jakevin.pokeshout.R.array.evolutionCandyCost));
    ...
    private void makeNotification() {
        ...
        NotificationCompat.Action openAppAction = new NotificationCompat.Action.Builder(
                ...
                getString(com.jakevin.pokeshout.R.string.notification_open_app),
        ...
        NotificationCompat.Action stopServiceAction = new NotificationCompat.Action.Builder(
                ...
                getString(com.jakevin.pokeshout.R.string.main_stop),
                stopServicePendingIntent).build();

        Notification notification = new NotificationCompat.Builder(this)
                .setOngoing(true)
                .setCategory(NotificationCompat.CATEGORY_SERVICE)
                .setColor(getColorC(com.jakevin.pokeshout.R.color.colorPrimary))
                .setSmallIcon(com.jakevin.pokeshout.R.drawable.notification_icon)
                .setContentTitle(getString(com.jakevin.pokeshout.R.string.notification_title, trainerLevel))
    ...
    private void createArcPointer() {
        ...
        arcPointer.setImageResource(com.jakevin.pokeshout.R.drawable.dot);

        Drawable dot = getDrawableC(com.jakevin.pokeshout.R.drawable.dot);
    ...
    private void createIVButton() {
        ...
        ivButton.setImageResource(com.jakevin.pokeshout.R.drawable.button);
    ...
    private void createInfoLayout() {
        ...
        infoLayout = (LinearLayout) inflater.inflate(com.jakevin.pokeshout.R.layout.dialog_info_window, null);
                ...
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_UP:
                        if (newParams.y != originalWindowY) {
                            ...
                            Toast.makeText(Pokefly.this, com.jakevin.pokeshout.R.string.position_handler_toast, Toast.LENGTH_SHORT).show();
                        }
                        break;
    ...
    private void createInputLayout() {
        pokeInputSpinnerAdapter = new PokemonSpinnerAdapter(this, com.jakevin.pokeshout.R.layout.spinner_pokemon, new ArrayList<Pokemon>());
    ...
    private void createExtendedResultEvolutionSpinner() {
        ...
        extendedEvolutionSpinnerAdapter = new PokemonSpinnerAdapter(this, com.jakevin.pokeshout.R.layout.spinner_evolution,
    ...
    private void populateTeamAppraisalSpinners() {
        ...
        if (GoIVSettings.getInstance(getBaseContext()).playerTeam() == 0) {
            adapterIvRange = ArrayAdapter.createFromResource(this,
                    com.jakevin.pokeshout.R.array.mystic_ivrange, com.jakevin.pokeshout.R.layout.spinner_appraisal);
            adapterPercentage = ArrayAdapter.createFromResource(this,
                    com.jakevin.pokeshout.R.array.mystic_percentage, com.jakevin.pokeshout.R.layout.spinner_appraisal);

        } else if (GoIVSettings.getInstance(getBaseContext()).playerTeam() == 1) {
            adapterIvRange = ArrayAdapter.createFromResource(this,
                    com.jakevin.pokeshout.R.array.valor_ivrange, com.jakevin.pokeshout.R.layout.spinner_appraisal);
            adapterPercentage = ArrayAdapter.createFromResource(this,
                    com.jakevin.pokeshout.R.array.valor_percentage, com.jakevin.pokeshout.R.layout.spinner_appraisal);
        } else {
            adapterIvRange = ArrayAdapter.createFromResource(this,
                    com.jakevin.pokeshout.R.array.instinct_ivrange, com.jakevin.pokeshout.R.layout.spinner_appraisal);
            adapterPercentage = ArrayAdapter.createFromResource(this,
                    com.jakevin.pokeshout.R.array.instinct_percentage, com.jakevin.pokeshout.R.layout.spinner_appraisal);
        }
    ...
    @OnClick({com.jakevin.pokeshout.R.id.pokePickerToggleSpinnerVsInput})
    /**
    ...
    private void setVisibility(TextView expanderText, LinearLayout expandedBox, boolean animate, boolean visible) {
        ...
        if (visible) {
            ...
            arrowDrawable = getDrawableC(com.jakevin.pokeshout.R.drawable.arrow_expand);
        } else {
            boxVisibility = View.GONE;
            arrowDrawable = getDrawableC(com.jakevin.pokeshout.R.drawable.arrow_collapse);
        }
    ...
    @OnClick({com.jakevin.pokeshout.R.id.resultsMoreInformationText})
    public void toggleMoreResultsBox() {
        toggleVisibility(resultsMoreInformationText, expandedResultsBox, true);
    }

    @OnClick({com.jakevin.pokeshout.R.id.inputAppraisalExpandBox})
    /**
    ...
    @OnClick(com.jakevin.pokeshout.R.id.btnDecrementLevel)
    ...
    @OnClick(com.jakevin.pokeshout.R.id.btnIncrementLevel)
    ...
    @OnClick(com.jakevin.pokeshout.R.id.btnIncrementLevelExpanded)
    public void incrementLevelExpanded() {
        expandedLevelSeekbar.setProgress(expandedLevelSeekbar.getProgress() + 1);
        populateAdvancedInformation(ScanContainer.scanContainer.currScan);
    }

    @OnClick(com.jakevin.pokeshout.R.id.explainCPPercentageComparedToMaxIV)
    public void explainCPPercentageComparedToMaxIV() {
        Toast.makeText(getApplicationContext(), com.jakevin.pokeshout.R.string.perfection_explainer, Toast.LENGTH_LONG).show();
    }

    @OnClick(com.jakevin.pokeshout.R.id.btnDecrementLevelExpanded)
    ...
    @OnClick(com.jakevin.pokeshout.R.id.btnCheckIv)
    /**
    ...
    public void checkIv() {
        ...
        if (!parseNumericInputs() || !pokemonHP.isPresent() || !pokemonCP.isPresent()) {
            Toast.makeText(this, com.jakevin.pokeshout.R.string.missing_inputs, Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        if (!ivScanResult.tooManyPossibilities && ivScanResult.getCount() == 0) {
            Toast.makeText(this, com.jakevin.pokeshout.R.string.ivtext_no_possibilities, Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        exResCompare.setTextColor(getColorC(enableCompare ? com.jakevin.pokeshout.R.color.colorPrimary : com.jakevin.pokeshout.R.color.unimportantText));
    ...
    private Pokemon interpretWhichPokemonUserInput() {
        ...
        if (pokeInputSpinner.getVisibility() == View.VISIBLE) { //user picked pokemon from spinner
            ...
            if (pokemon == null) { //no such pokemon was found, show error toast and abort showing results
                Toast.makeText(this, userInput + getString(com.jakevin.pokeshout.R.string.wrong_pokemon_name_input),
    ...
    private void initializePokemonAutoCompleteTextView() {
        String[] pokeList = getResources().getStringArray(com.jakevin.pokeshout.R.array.pokemon);
        ArrayAdapter<String> adapter = new ArrayAdapter<>(this, com.jakevin.pokeshout.R.layout.autocomplete_pokemon_list_item,
                pokeList);
    ...
    private void adjustSeekbarsThumbs() {
        ...
        // trainer level
        expandedLevelSeekbarBackground.getThumb(0).setThumb(getDrawableC(com.jakevin.pokeshout.R.drawable
    ...
    private void populatePrevScanNarrowing() {
        if (ScanContainer.scanContainer.isScanRefinable()) {
            ...
            exResPrevScan.setText(String.format(getString(com.jakevin.pokeshout.R.string.last_scan),
    ...
    private void populateResultsHeader(IVScanResult ivScanResult) {
        ...
        resultsPokemonLevel.setText(getString(com.jakevin.pokeshout.R.string.level_num, ivScanResult.estimatedPokemonLevel));
    }
    ...
    private void populateMultipleIVMatch(IVScanResult ivScanResult) {
        ...
        tvAvgIV.setText(getString(com.jakevin.pokeshout.R.string.avg));
        if (ivScanResult.tooManyPossibilities) {
            resultsCombinations.setText(getString(com.jakevin.pokeshout.R.string.too_many_iv_combinations));
        } else {
            resultsCombinations.setText(
                    String.format(getString(com.jakevin.pokeshout.R.string.possible_iv_combinations), ivScanResult.iVCombinations.size()));
        }
    ...
    private void populateSingleIVMatch(IVScanResult ivScanResult) {
        ...
        tvAvgIV.setText(getString(com.jakevin.pokeshout.R.string.iv));
    ...
    private void setAndCalculatePokeSpamText(IVScanResult ivScanResult) {
        if (GoIVSettings.getInstance(getApplicationContext()).isPokeSpamEnabled()
            ...
            if (ivScanResult.pokemon.candyEvolutionCost < 0) {
                exResPokeSpam.setText(getString(com.jakevin.pokeshout.R.string.pokespam_not_available));
            ...
            String text = getString(com.jakevin.pokeshout.R.string.pokespam_formatted_message,
    ...
    private void setEstimateLevelTextColor(double selectedLevel) {
        ...
        if (selectedLevel > Data.trainerLevelToMaxPokeLevel(trainerLevel)) {
            exResLevel.setTextColor(getColorC(com.jakevin.pokeshout.R.color.orange));
        } else {
            exResLevel.setTextColor(getColorC(com.jakevin.pokeshout.R.color.importantText));
        }
    }
    ...
    private void setResultScreenPercentageRange(IVScanResult ivScanResult) {
        ...
        if (ivScanResult.iVCombinations.size() > 0) {
            resultsMinPercentage.setText(getString(com.jakevin.pokeshout.R.string.percent, low));
            resultsAvePercentage.setText(getString(com.jakevin.pokeshout.R.string.percent, ave));
            resultsMaxPercentage.setText(getString(com.jakevin.pokeshout.R.string.percent, high));
        } else {
            String unknown_percent = getString(com.jakevin.pokeshout.R.string.unknown_percent);
    ...
    @OnClick({com.jakevin.pokeshout.R.id.btnCancelInfo, com.jakevin.pokeshout.R.id.btnCloseInfo})
    /**
    ...
    public void reduceScanByComparison() {
        ...
        if (prevScan != null) {
            ...
            if (changed) {
                ...
                Toast.makeText(this, com.jakevin.pokeshout.R.string.refine_no_progress, Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    @OnClick(com.jakevin.pokeshout.R.id.btnBackInfo)
    ...
    private void scanPokemon(Bitmap pokemonImage, @NonNull Optional<String> screenShotPath) {
        ...
        try {
            ...
            if (res.isFailed()) {
                Toast.makeText(Pokefly.this, getString(com.jakevin.pokeshout.R.string.scan_pokemon_failed), Toast.LENGTH_SHORT).show();
            }
