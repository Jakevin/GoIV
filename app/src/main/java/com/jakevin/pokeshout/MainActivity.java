...
import com.jakevin.pokeshout.clipboard.ClipboardModifierActivity;
...
import com.jakevin.pokeshout.updater.DownloadUpdateService;
import com.jakevin.pokeshout.widgets.PlayerTeamAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.jakevin.pokeshout.R.layout.activity_main);

        PreferenceManager.setDefaultValues(this, com.jakevin.pokeshout.R.xml.settings, false);

        TextView tvVersionNumber = (TextView) findViewById(com.jakevin.pokeshout.R.id.version_number);
        tvVersionNumber.setText(getVersionName());

        TextView goIvInfo = (TextView) findViewById(com.jakevin.pokeshout.R.id.goiv_info);
        ...
        final NumberPicker npTrainerLevel = (NumberPicker) findViewById(com.jakevin.pokeshout.R.id.trainerLevel);
        ...
        launchButton = (Button) findViewById(com.jakevin.pokeshout.R.id.start);
    ...
    private void initiateTeamPickerSpinner() {
        Spinner spinner = (Spinner) findViewById(com.jakevin.pokeshout.R.id.teamPickerSpinner);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(com.jakevin.pokeshout.R.menu.main_menu, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case com.jakevin.pokeshout.R.id.settings:
    ...
    private void startPokeFly() {
        launchButton.setText(com.jakevin.pokeshout.R.string.main_starting);
    ...
    private void updateLaunchButtonText(boolean isPokeflyRunning) {
        if (!hasAllPermissions()) {
            launchButton.setText(com.jakevin.pokeshout.R.string.main_permission);
        } else if (isPokeflyRunning) {
            launchButton.setText(com.jakevin.pokeshout.R.string.main_stop);
        } else {
            launchButton.setText(com.jakevin.pokeshout.R.string.main_start);
        }
    }
    ...
    private void startScreenService() {
        launchButton.setText(com.jakevin.pokeshout.R.string.accept_screen_capture);
        MediaProjectionManager projectionManager = (MediaProjectionManager) getSystemService(
                Context.MEDIA_PROJECTION_SERVICE);
